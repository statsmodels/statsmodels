...
# Describe, fit, and summarize the OLS model
model = sm.OLS(y, X)
results = model.fit()
...
# Artificial data: We create 3 groups which will be modelled using dummy
...
# The Longley dataset is well known to have high multicollinearity. We load
# these data with:
