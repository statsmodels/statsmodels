...
# linear_regression_diagnostics_plots.ipynb
#
...
#
# A high leverage guideline can also be displayed using the convention:
# $h_{ii} > {2p \over n}$.
...
# fig.savefig('../../docs/source/_static/images/linear_regression_diagnost
# ics_plots.png')
