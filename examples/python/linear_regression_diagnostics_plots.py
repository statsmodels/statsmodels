...
# In real-life, relation between response and target variables are seldom linear. 
# Here, we make use of outputs of ``statsmodels`` to visualise and identify potential problems that can occur 
# from fitting ``linear regression`` model to non-linear relation. Primarily, the aim is to reproduce visualisations 
# discussed in Potential Problems section (Chapter 3.3.3) of *An Introduction to Statistical Learning* (ISLR) book by James et al., Springer.
