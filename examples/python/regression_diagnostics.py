...
# Jarque-Bera test:
#
# Kurtosis below is the sample kurtosis, not the excess kurtosis. A sample
# from the normal distribution has kurtosis equal to 3.
...
# Durbin-Watson test:
#
# DW statistic always ranges from 0 to 4. The closer to 2, the less
# autocorrelation is in the sample.
...
name = ["F statistic", "p-value", "ordering"]
