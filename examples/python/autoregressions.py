...
# `plot_diagnostics` indicates that the model captures the key features in
# the data.
...
# the data. The ACF shows a pattern at the seasonal frequency and so a more
