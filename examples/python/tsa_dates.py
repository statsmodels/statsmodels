...
# This just returns a regular array, but since the model has date
# information attached, you can get the prediction dates in a roundabout
# way.

print(ar_res.data.predict_dates)

# Note: This attribute only exists if predict has been called. It holds
