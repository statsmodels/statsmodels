...
# A reset test is a test for correct specification of the link function.
# The standard form of the test adds polynomial terms of the linear
# predictor as extra regressors and test for their significance.
#
