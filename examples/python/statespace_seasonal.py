...
print(
    f"fixed intercept estimated as {res_f.smoother_results.smoothed_state[0, -1:][0]:.3f}"
)
...
# The first state variable holds our estimate of the intercept
print(
    f"fixed intercept estimated as {res_tf.smoother_results.smoothed_state[0, -1:][0]:.3f}"
)
...
# The first state variable holds our estimate of the intercept
print(
    f"fixed intercept estimated as {res_lf.smoother_results.smoothed_state[0, -1:][0]:.3f}"
)
...
# The first state variable holds our estimate of the intercept
print(
    f"fixed intercept estimated as {res_lt.smoother_results.smoothed_state[0, -1:][0]:.3f}"
)
