...
# Dataset
wpi1 = requests.get("https://www.stata-press.com/data/r12/wpi1.dta", timeout=30).content
...
# Dataset
air2 = requests.get("https://www.stata-press.com/data/r12/air2.dta", timeout=30).content
...
friedman2 = requests.get(
    "https://www.stata-press.com/data/r12/friedman2.dta", timeout=30
).content
