'''load example data
duplicate of this module in tests
'''
...
def longley():
    ...
    x=data[:,1:]
    return y,x
#Note that Longley is now included in datasets...
