...
def get_validation_data(doc):
    ...
    for section in unexpected_sections:
        errs.append(error('GL06', section=section,
    ...
    if (doc.deprecated and
            not doc.extended_summary.startswith('.. deprecated:: ')):
...
if __name__ == '__main__':
    ...
    argparser.add_argument('function', nargs='?', default=None,
                           help=func_help)
