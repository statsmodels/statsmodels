...
echo conda install --channel conda-forge sphinx jupyter nbconvert numpydoc pyyaml r-robustbase r-lme4 r-geepack libiconv rpy2 --yes --quiet
conda install --channel conda-forge sphinx jupyter nbconvert numpydoc pyyaml r-robustbase r-lme4 r-geepack libiconv rpy2 --yes --quiet
# doctr and pdr
