...
python -m pip install "cython>=0.29.33,<4.0.0" "pytest~=7.0.1" pytest-xdist coverage pytest-cov ipython jupyter notebook nbconvert isort flake8 nbconvert==5.6.1 coveralls setuptools_scm[toml]~=8.0
