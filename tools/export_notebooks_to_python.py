...
def main():
    ...
    if full_path is None:
        full_path = BASE_PATH / ".." / "examples" / "notebooks"
    else:
        full_path = Path(full_path)
    notebook = args.notebook
    if notebook is None:
        notebooks = list(full_path.glob("*.ipynb"))
    else:
        if not notebook.endswith(".ipynb"):
            notebook = notebook + ".ipynb"
        notebook = (full_path / notebook).resolve()
    ...
    for nb in notebooks:
        nb_full_name = nb.name
        nb_name = nb.stem
        py_name = nb_name + ".py"
        # Get base directory to notebook
        out_file = nb.parent
        # Write to ../python
        out_file = out_file / ".." / "python" / py_name
        ...
        with nb.open(encoding="utf8") as nb_file:
            ...
            with out_file.open("w", encoding="utf8", newline="\n") as of:
                of.write(code_out)
