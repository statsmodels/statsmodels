...
class TestBetaModel:
    ...
    def test_income_precision(self):
        rslt = self.income_fit
        assert_close(
            np.exp(rslt.params[-1:]), expected_income_precision["Estimate"], 0.001
        )
