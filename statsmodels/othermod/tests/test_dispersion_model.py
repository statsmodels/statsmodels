...
class BetaMultiLink(MultiLinkModel):
...
class TestGaussianHetWLS(CheckCompare):
    ...
    def setup_class(cls):
        ...
        _, s_ = mod1._predict_dargs(res1.params)
...
class TestGammaHetGLM(CheckCompare):
    ...
    def setup_class(cls):
        ...
        mod1 = odm.GammaHet(y, exog, exog_scale=exog, k_extra=0)
...
class TestTHet(CheckCompare):
    ...
    def setup_class(cls):
        ...
        # df1, m1, s1 = mod1._predict_dargs(res1.params)
