...
if __name__ == '__main__':
    ...
    if verbose:
        ...
        print(misc.derivative(llt, 1.5, dx=1e-10, n=1, args=(0,1,20), order=3), end=' ')
        print('ts', locscale_grad(1.5, 0, 1, ts_dlldy, 20))
        print(misc.derivative(llt, 1.5, dx=1e-10, n=1, args=(0,2,20), order=3), end=' ')
        print('ts', locscale_grad(1.5, 0, 2, ts_dlldy, 20))
        print(misc.derivative(llt, 1.5, dx=1e-10, n=1, args=(1,2,20), order=3), end=' ')
        print('ts', locscale_grad(1.5, 1, 2, ts_dlldy, 20))
        print(misc.derivative(lltloc, 1, dx=1e-10, n=1, args=(1.5,2,20), order=3), end=' ')
        ...
        print(misc.derivative(lltloc, loc, dx=1e-10, n=1, args=(y,scale,df), order=3), end=' ')
        ...
        print(misc.derivative(llnormloc, loc, dx=1e-10, n=1, args=(y,scale), order=3), end=' ')
