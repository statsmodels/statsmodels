...
def distfitmc(sample, distr, nrepl=100, distkwds=None):
    ...
    """
    distkwds = {} if distkwds is None else distkwds.copy()
...
if __name__ == "__main__":
    ...
    if "montecarlo" in examplecases:
        print("\nMonteCarlo")
        mcres = distfitmc(
            sample, distr, nrepl=nrepl, distkwds=dict(arg=arg, loc=loc, scale=scale)
        )
