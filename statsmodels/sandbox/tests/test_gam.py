...
class CheckAM:
    ...
    @pytest.mark.xfail(
        reason="Unknown, results do not match expected",
    ...
    def test_fitted(self):
        ...
        assert_almost_equal(
            self.res1.y_predshort, self.res2.fittedvalues[:10], decimal=2
        )
    ...
    @pytest.mark.xfail(
        reason="res_ps attribute does not exist", strict=True, raises=AttributeError
    )
    def test_df(self):
