...
impdata.new_imputer("x2", method="gaussian", k_pmm=20, scale_method="perturb_boot")
#impdata.new_imputer("x3", model_class=sm.Poisson, method="pmm", k_pmm=20)
impdata.new_imputer("x1", method="gaussian", k_pmm=20, model_class=sm.Logit, scale_method="perturb_boot")
