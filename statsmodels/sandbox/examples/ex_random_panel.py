...
if "ex1" in examples:
    ...
    # without correction
    cov_clu2 = sw.cov_cluster(
        mod2.res_pooled, dgp.groups.astype(int), use_correction=False
    )
    ...
    cov_pnw0 = sw.cov_nw_panel(
        mod2.res_pooled, 0, mod2.group.groupidx, use_correction="hac"
    )
    ...
    c2, ct, cg = sw.cov_cluster_2groups(
        mod2.res_pooled, time, dgp.groups.astype(int), use_correction=False
    )
    ct_nw0 = cov_nw_panel2(
        mod2.res_pooled, 0, time, weights_func=sw.weights_uniform, use_correction=False
    )
    cg_nw0 = cov_nw_panel2(
        mod2.res_pooled,
        0,
        dgp.groups.astype(int),
        weights_func=sw.weights_uniform,
        use_correction=False,
    )
