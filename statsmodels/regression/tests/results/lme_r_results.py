...
vcov_reml_drf_2 = np.array(
    [0.001190455, 1.482666e-05, 1.482666e-05, 0.001066002]
).reshape(2, 2, order="F")
...
cov_re_ml_drf_6 = np.array([0.2595201, 0.04591071, 0.04591071, 2.204612]).reshape(
    2, 2, order="F"
)
...
cov_re_reml_drf_6 = np.array([0.2595767, 0.04590012, 0.04590012, 2.204822]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_6 = np.array(
    [0.2421365, 0.2221108, 0.2221108, 0.4244443]
).reshape(2, 2, order="F")
...
cov_re_ml_drf_7 = np.array([0.2051329, 0.0734377, 0.0734377, 3.285381]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_7 = np.array(
    [0.1823183, 0.02247519, 0.02247519, 1.125011]
).reshape(2, 2, order="F")
...
cov_re_reml_drf_7 = np.array([0.2056226, 0.0726139, 0.0726139, 3.2876]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_7 = np.array(
    [0.1828266, 0.02229138, 0.02229138, 1.128947]
).reshape(2, 2, order="F")
...
cov_re_ml_drf_8 = np.array([0.1506188, 0.126091, 0.126091, 2.485462]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_8 = np.array(
    [0.05400391, 0.002330104, 0.002330104, 0.122761]
).reshape(2, 2, order="F")

coef_reml_drf_8 = np.array([-1.083938, 0.8956893])

vcov_reml_drf_8 = np.array(
    [0.002528969, 0.0001712206, 0.0001712206, 0.002573335]
).reshape(2, 2, order="F")

cov_re_reml_drf_8 = np.array([0.1505098, 0.1256311, 0.1256311, 2.484219]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_8 = np.array(
    [0.05463632, 0.002393538, 0.002393538, 0.1249828]
).reshape(2, 2, order="F")

coef_ml_irf_8 = np.array([-1.079481, 0.898216])

vcov_ml_irf_8 = np.array(
    [0.002511536, 0.0001812511, 0.0001812511, 0.002573405]
).reshape(2, 2, order="F")
...
vcov_reml_irf_8 = np.array(
    [0.002549354, 0.0001833386, 0.0001833386, 0.002614672]
).reshape(2, 2, order="F")
...
cov_re_ml_drf_9 = np.array([0.510175, 0.08826114, 0.08826114, 3.342888]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_9 = np.array(
    [0.3994872, 0.02478884, 0.02478884, 1.195077]
).reshape(2, 2, order="F")
...
cov_re_reml_drf_9 = np.array([0.5123204, 0.08897376, 0.08897376, 3.341722]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_9 = np.array(
    [0.401762, 0.02521271, 0.02521271, 1.203536]
).reshape(2, 2, order="F")
...
cov_re_ml_drf_10 = np.array([0.2040541, 0.09038325, 0.09038325, 2.218903]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_10 = np.array(
    [0.1988816, 0.1872403, 0.1872403, 0.4052274]
).reshape(2, 2, order="F")
...
ranef_condvar_reml_drf_10 = np.array(
    [0.1983981, 0.1865469, 0.1865469, 0.4100937]
).reshape(2, 2, order="F")
...
cov_re_ml_drf_11 = np.array([0.3719096, 0.332198, 0.332198, 1.120588]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_11 = np.array(
    [0.2987928, 0.1992074, 0.1992074, 0.7477486]
).reshape(2, 2, order="F")
...
cov_re_reml_drf_11 = np.array([0.3680346, 0.3324419, 0.3324419, 1.118623]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_11 = np.array(
    [0.2965372, 0.2010191, 0.2010191, 0.7503986]
).reshape(2, 2, order="F")
