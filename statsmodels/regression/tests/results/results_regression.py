...
class Longley(object):
    ...
    def __init__(self):
        ...
        self.resid_pearson = np.array((0.87694426, -0.30838998,
    ...
    def conf_int(self): # a method to be consistent with sm
        return [(-177.0291, 207.1524), (-.111581, .0399428),
                (-3.125065, -.9153928), (-1.517948, -.5485049),
                (-.5625173, .4603083), (798.7873, 2859.515),
                (-5496529, -1467987)]
...
class LongleyRTO(object):
    def __init__(self):
        ...
        # Obtained from R using m$residuals / sqrt(sum(m$residuals * m$residuals) / m$df.residual)
        self.resid_pearson = [0.58906369, -0.27427213, 0.19094881,
