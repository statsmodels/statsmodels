...
def qqplot_2samples(data1, data2, xlabel=None, ylabel=None, line=None, ax=None, **plotkwargs):
    """
    ...
    **plotkwargs
    ...
    if data2.data.shape[0] > data1.data.shape[0]:
        fig = data1.qqplot(xlabel=xlabel, ylabel=ylabel, line=line, other=data2, ax=ax, **plotkwargs)
    else:
        fig = data2.qqplot(
            xlabel=ylabel,
            ylabel=xlabel,
