...
cdef void schandrasekhar_recursion(sKalmanFilter kfilter, sStatespace model, int i, np.float32_t forecast_error_cov_inv, np.float32_t forecast_error_cov_inv_prev)
...
cdef void dchandrasekhar_recursion(dKalmanFilter kfilter, dStatespace model, int i, np.float64_t forecast_error_cov_inv, np.float64_t forecast_error_cov_inv_prev)
...
cdef void cchandrasekhar_recursion(cKalmanFilter kfilter, cStatespace model, int i, np.complex64_t forecast_error_cov_inv, np.complex64_t forecast_error_cov_inv_prev)
...
cdef void zchandrasekhar_recursion(zKalmanFilter kfilter, zStatespace model, int i, np.complex128_t forecast_error_cov_inv, np.complex128_t forecast_error_cov_inv_prev)
