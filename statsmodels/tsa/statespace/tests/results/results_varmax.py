...
lutkepohl_var1 = {
    "params": [
        -0.25034303,
        0.28759168,
        0.81626475,  # Phi, row 1
        0.023383,
        0.19048278,
        0.66502259,  # Phi, row 2
        -0.01492992,
        0.53796097,
        0.28114733,  # Phi, row 3
...
lutkepohl_var1_diag = {
    "params": [
        -0.24817904,
        0.29283012,
        0.80794938,  # Phi, row 1
        0.02282985,
        0.19672157,
        0.66329776,  # Phi, row 2
        -0.01522531,
        0.53500874,
        0.28859213,  # Phi, row 3
        0.00199106,
        0.00018529,
        0.00016179,  # Variances, diagonal
    ],
    "var_oim": [
        0.01314245,
        0.1902972,
...
lutkepohl_var1_obs_intercept = {
    "params": [
        -0.24762,
        0.25961003,
        0.75992623,  # Phi, row 1
        0.03186854,
        -0.07271862,
        0.23697765,  # Phi, row 2
        -0.0053055,
        0.2362571,
        -0.19438311,  # Phi, row 3
        0.00199116,
        0.00013515,
        0.00009937,  # Variances, diagonal
    ],
    "obs_intercept": [0.01799302, 0.02065458, 0.01987525],  # Intercepts
    "var_oim": [
        0.01317874,
        0.2311403,
        0.33481866,
...
lutkepohl_var1_exog = {
    "params": [
        -0.25549409,
        0.31149462,
        0.92674046,  # Phi, row 1
        0.02935715,
        0.13699757,
        0.5059042,  # Phi, row 2
        -0.00540021,
        0.4598014,
        0.06065565,  # Phi, row 3
        -0.00007533,
        0.00012771,
        0.00018224,  # exog
        ...
        # Note: the following are the Cholesky of the covariance
        # matrix defined just above
        0.04479029,  # Cholesky, lower triangle
        0.00157467,
        0.01302614,
        0.00311094,
        0.00731692,
    ...
    "var_oim": [
        0.01350243,
        0.20429977,
        0.29684366,  # Phi, row 1
        0.00115871,
        0.01753203,
        0.02547371,  # Phi, row 2
        0.000931,
        0.01408662,
        0.02046759,  # Phi, row 3
        3.720e-08,
        3.192e-09,
        2.565e-09,  # exog
    ],
...
lutkepohl_var1_exog2 = {
    "params": [
        -0.2552236,
        0.21722691,
        0.81525457,  # Phi, row 1
        0.02998355,
        -0.08130972,
        0.24772266,  # Phi, row 2
        -0.00476998,
        0.24016112,
        -0.19910237,  # Phi, row 3
        0.00811096,
        -0.00015244,  # exog, y1
        0.01878355,
        -0.00005086,  # exog, y2
        ...
        # Note: the following are the Cholesky of the covariance
        # matrix defined just above
        0.04471219,  # Cholesky, lower triangle
        0.00121555,
        0.01102644,
        0.00275227,
        0.00536569,
...
lutkepohl_var2 = {
    "params": [
        -0.25244981,
        0.62528114,  # Phi_1, row 1
        -0.13011679,
        0.58173748,  # Phi_1, row 2
        0.05369178,
        0.35716349,  # Phi_2, row 1
        0.03861472,
        0.43812606,  # Phi_2, row 2
    ...
    "var_oim": [
        0.01315844,
        0.11805816,  # Phi_1, row 1
        0.01321036,
        0.11300702,  # Phi_1, row 2
        0.00122666,
        0.01064478,  # Phi_2, row 1
        0.0012571,
        0.0106738,  # Phi_2, row 2
...
fred_varma11 = {
    "params": [
        ...
        0,  # Phi_1, row 1
        0.17348681,
        -0.48093755,  # Phi_1, row 2
        -0.51890703,
        0,  # Theta_1, row 1
        0,
        0,  # Theta_1, row 2
        0.0000582,
        0.00003815,  # Variances
    ],
    "var_oim": [
        0.00272999,
        0,  # Phi_1, row 1
        0.00164152,
        0.00248576,  # Phi_1, row 2
        0.0049259,
        0,  # Theta_1, row 1
        0,
        0,  # Theta_1, row 2
