...
realgdp_results = pd.read_csv(os.path.join(current_path, realgdp_path))
...
class TestARIMAStationary(ARIMA):
    ...
    def test_bse_approx(self):
        ...
        #         approx_centered=True).diagonal()**0.5
    ...
    def test_bse_robust(self):
        ...
        robust_oim_bse = result.cov_params_robust_oim.diagonal()**0.5
        robust_approx_bse = result.cov_params_robust_approx.diagonal()**0.5
        true_robust_bse = np.r_[self.true['se_ar_robust'],
                                self.true['se_ma_robust']]
...
class TestAirlineHamilton(Airline):
    ...
    def test_bse_approx(self):
        ...
        #     assert_allclose(bse[1],
        #                     self.true['se_seasonal_ma_oim'],
        #                     atol=1e-2)
...
class SARIMAXCoverageTest(object):
    ...
    def setup_class(cls, i, decimal=4, endog=None, *args, **kwargs):
        ...
        cls.true_params = np.array(
            [float(x)
             for x in coverage_results.loc[i]['parameters'].split(',')])
    ...
    def test_transform_untransform(self):
        ...
        contracted_polynomial_seasonal_ar = self.model.polynomial_seasonal_ar[
            self.model.polynomial_seasonal_ar.nonzero()]

        self.model.enforce_stationarity = (
            (self.model.k_ar == 0 or
             tools.is_invertible(np.r_[1, -self.model.polynomial_ar[1:]])) and
            (len(contracted_polynomial_seasonal_ar) <= 1 or
             tools.is_invertible(
                np.r_[1, -contracted_polynomial_seasonal_ar[1:]]))
        )
        contracted_polynomial_seasonal_ma = self.model.polynomial_seasonal_ma[
            self.model.polynomial_seasonal_ma.nonzero()]

        self.model.enforce_invertibility = (
            (self.model.k_ma == 0 or
             tools.is_invertible(np.r_[1, self.model.polynomial_ma[1:]])) and
            (len(contracted_polynomial_seasonal_ma) <= 1 or
             tools.is_invertible(np.r_[1,
                                       contracted_polynomial_seasonal_ma[1:]]))
        )
    ...
    def test_predict(self):
        ...
        if self.model.k_exog == 0:
            ...
            exog = np.r_[[0]*self.model.k_exog*11].reshape(11,
                                                           self.model.k_exog)
...
class Test_ar_trend_c(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        cls.true_params[0] = ((1 - cls.true_params[1:4].sum()) *
                              cls.true_params[0])
...
class Test_ar_trend_ct(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        # Modify true params to convert from mean to intercept form
        cls.true_params[:2] = ((1 - cls.true_params[2:5].sum()) *
                               cls.true_params[:2])
...
class Test_arma_trend_c(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        # Modify true params to convert from mean to intercept form
        cls.true_params[:1] = ((1 - cls.true_params[1:4].sum()) *
                               cls.true_params[:1])
...
class Test_arma_diff_seasonal_diff(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        kwargs['order'] = (3, 2, 2)
        kwargs['seasonal_order'] = (0, 2, 0, 4)
        super(Test_arma_diff_seasonal_diff,
              cls).setup_class(22, *args, **kwargs)
...
class Test_seasonal_ar_as_polynomial(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        super(Test_seasonal_ar_as_polynomial,
              cls).setup_class(25, *args, **kwargs)
...
class Test_seasonal_ar_trend_polynomial(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        kwargs['seasonal_order'] = (3, 0, 0, 4)
        kwargs['trend'] = [1, 0, 0, 1]
        super(Test_seasonal_ar_trend_polynomial,
              cls).setup_class(28, *args, **kwargs)
        # Modify true params to convert from mean to intercept form
        cls.true_params[:2] = ((1 - cls.true_params[2:5].sum()) *
                               cls.true_params[:2])
...
class Test_seasonal_ar_seasonal_diff(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        super(Test_seasonal_ar_seasonal_diff,
              cls).setup_class(30, *args, **kwargs)
...
class Test_seasonal_ma_as_polynomial(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        super(Test_seasonal_ma_as_polynomial,
              cls).setup_class(33, *args, **kwargs)
...
class Test_seasonal_ma_trend_polynomial(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        kwargs['trend'] = [1, 0, 0, 1]
        kwargs['decimal'] = 3
        super(Test_seasonal_ma_trend_polynomial,
              cls).setup_class(36, *args, **kwargs)
...
class Test_seasonal_ma_seasonal_diff(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        super(Test_seasonal_ma_seasonal_diff,
              cls).setup_class(38, *args, **kwargs)
...
class Test_seasonal_arma_trend_ct(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        kwargs['seasonal_order'] = (3, 0, 2, 4)
        kwargs['trend'] = 'ct'
        super(Test_seasonal_arma_trend_ct,
              cls).setup_class(43, *args, **kwargs)
        # Modify true params to convert from mean to intercept form
        cls.true_params[:2] = ((1 - cls.true_params[2:5].sum()) *
                               cls.true_params[:2])
...
class Test_seasonal_arma_trend_polynomial(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        kwargs['trend'] = [1, 0, 0, 1]
        kwargs['decimal'] = 3
        super(Test_seasonal_arma_trend_polynomial,
              cls).setup_class(44, *args, **kwargs)
        # Modify true params to convert from mean to intercept form
        cls.true_params[:2] = ((1 - cls.true_params[2:5].sum()) *
                               cls.true_params[:2])
...
class Test_seasonal_arma_seasonal_diff(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        super(Test_seasonal_arma_seasonal_diff,
              cls).setup_class(46, *args, **kwargs)
...
class Test_seasonal_arma_diff_seasonal_diff(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        kwargs['order'] = (0, 2, 0)
        kwargs['seasonal_order'] = (3, 2, 2, 4)
        super(Test_seasonal_arma_diff_seasonal_diff,
              cls).setup_class(47, *args, **kwargs)
...
class Test_seasonal_arma_exogenous(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        endog = results_sarimax.wpi1_data
        kwargs['exog'] = (endog - np.floor(endog))**2
        super(Test_seasonal_arma_exogenous,
              cls).setup_class(49, *args, **kwargs)
...
class Test_sarimax_exogenous_not_hamilton(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        super(Test_sarimax_exogenous_not_hamilton,
              cls).setup_class(50, *args, **kwargs)


class Test_sarimax_exogenous_diffuse(SARIMAXCoverageTest):
    # // SARIMAX and exogenous diffuse
    # arima wpi x, arima(3, 2, 2) sarima(3, 2, 2, 4) noconstant vce(oim)
    # diffuse save_results 52
    @classmethod
    def setup_class(cls, *args, **kwargs):
        kwargs['order'] = (3, 2, 2)
        kwargs['seasonal_order'] = (3, 2, 2, 4)
        ...
        kwargs['initialization'] = 'approximate_diffuse'
        kwargs['initial_variance'] = 1e9
        super(Test_sarimax_exogenous_diffuse,
              cls).setup_class(51, *args, **kwargs)
...
class Test_arma_exog_trend_polynomial_missing(SARIMAXCoverageTest):
    ...
    def setup_class(cls, *args, **kwargs):
        ...
        kwargs['decimal'] = 1
        super(Test_arma_exog_trend_polynomial_missing,
              cls).setup_class(52, endog=endog, *args, **kwargs)
        # Modify true params to convert from mean to intercept form
        cls.true_params[0] = ((1 - cls.true_params[2:5].sum()) *
                              cls.true_params[0])
...
def test_simple_time_varying():
    ...
    # 5 digits necessary to accommodate 32-bit numpy / scipy with
    # OpenBLAS 0.2.18
