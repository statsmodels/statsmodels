...
def x13_arima_analysis(endog, maxorder=(2, 1), maxdiff=(2, 1), diff=None,
                       ...
                       print_stdout=False, x12path=None, prefer_x13=True, dir=None):
    """
    ...
    dir : str
        ...
        If None, the function will create files in 
    ...
    ftempin = tempfile.NamedTemporaryFile(delete=False, suffix='.spc', dir=dir)
    ftempout = tempfile.NamedTemporaryFile(delete=False, dir=dir)
    try:
...
def x13_arima_select_order(endog, maxorder=(2, 1), maxdiff=(2, 1), diff=None,
                           ...
                           x12path=None, prefer_x13=True, dir=None):
    """
    ...
    results = x13_arima_analysis(endog, x12path=x12path, exog=exog, log=log,
                                 ...
                                 start=start, freq=freq, prefer_x13=prefer_x13, dir=dir)
