...
conv1 = np.array([np.nan, 118.75, 155.5, 197.75, 238.75, 239.5, 228, 303,
                  629, 789, 599.75, 499.25, 527.25, 477.75, 260.5, 180.75,
                  296.75, 263.5, 155.75, 108.5, 199.5, 379.75, 109.5, 74.25,
                  56.75, -95, -93, -29, 90.5, 302, 56.5, 126.75])
...
conv2_na = np.array([118.75, 155.5, 197.75, 238.75, 239.5, 228, 303, 629,
                     np.nan, np.nan, 499.25, 527.25, 477.75, 260.5, 180.75,
                     296.75, 263.5, 155.75, 108.5, 199.5, 379.75, 109.5,
                     74.25, 56.75, -95, -93, -29, 90.5, 302, 56.5, 126.75,
                     np.nan])

conv1_na = np.array([np.nan, 118.75, 155.5, 197.75, 238.75, 239.5, 228,
                     303, 629, np.nan, np.nan, 499.25, 527.25, 477.75,
                     260.5, 180.75, 296.75, 263.5, 155.75, 108.5, 199.5,
                     379.75, 109.5, 74.25, 56.75, -95, -93, -29, 90.5,
                     302, 56.5, 126.75])
