...
z_nc_smallp = np.array([[.0342, -.6376,0,-.03872],
                    [1.3426,-.7680,0,-.04104],
...
z_c_smallp = np.array([[2.2142,-1.7863,.32828,-.07727],
                   [1.1662,.1814,-.36707,0],
...
z_ct_smallp = np.array([ [4.6476,-2.8932,0.5832,-0.0999],
...
z_ctt_smallp = np.array([ [3.6739,-1.1549,0,-0.03947],
...
z_large_scaling = np.array([1,1e-1,1e-2,1e-3,1e-5])
z_nc_largep = np.array([ [0.4927,6.906,13.2331,12.099,0],
...
z_c_largep = np.array([ [1.717,5.5243,4.3463,1.6671,0],
...
z_ct_largep = np.array([ [2.7117,4.5731,2.2868,0.6362,0.5],
...
z_ctt_largep = np.array([ [3.4671,4.3476,1.9231,0.5381,0.6216],
