...
yhat_mle = pd.read_csv(
    current_path / "yhat_exact_nc.csv", header=None, skiprows=1
).values
yhat_css = pd.read_csv(current_path / "yhat_css_nc.csv", header=None, skiprows=1).values
yhatc_mle = pd.read_csv(
    current_path / "yhat_exact_c.csv", header=None, skiprows=1
).values
yhatc_css = pd.read_csv(current_path / "yhat_css_c.csv", header=None, skiprows=1).values

resids_mle = pd.read_csv(
    current_path / "resids_exact_nc.csv", header=None, skiprows=1
).values
resids_css = pd.read_csv(
    current_path / "resids_css_nc.csv", header=None, skiprows=1
).values
residsc_mle = pd.read_csv(
    current_path / "resids_exact_c.csv", header=None, skiprows=1
).values
residsc_css = pd.read_csv(
    current_path / "resids_css_c.csv", header=None, skiprows=1
).values
forecast_results = pd.read_csv(
    current_path / "results_arma_forecasts.csv", header=0, dtype=float
)
