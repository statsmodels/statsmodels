...
res_ord_probit.coefficients_pval = np.array([0.0001513681, 0.9531256, 0.02232519])
...
res_ord_cloglog.coefficients_pval = np.array([0.001364927, 0.5200475, 0.03012421])
res_ord_cloglog.thresholds = np.array([0.8705304, 1.974466])
res_ord_cloglog.prob_pred = np.array(
    [
        [0.5519526, 0.3592524, 0.088795],
        [0.3855287, 0.3842645, 0.23020682],
        [0.2899487, 0.3540202, 0.35603111],
        [0.6067184, 0.3333548, 0.05992678],
        [0.6411418, 0.3133969, 0.04546127],
        [0.5940557, 0.3400072, 0.0659371],
        [0.6374521, 0.3156622, 0.0468857],
    ]
)
