...
class TestMisra1c(TestNonlinearLS):
    ...
    def setup(self):
        ...
        self.res_start2 = mod2.fit(start_value=[600.0, 0.00020000000000000001])

    def test_basic(self):
        res1 = self.res_start1
        res2 = self.res_start2
        assert_almost_equal(res1.params,[636.42725809000001, 0.00020813627256],decimal=3)
        assert_almost_equal(res2.params,[636.42725809000001, 0.00020813627256],decimal=3)
