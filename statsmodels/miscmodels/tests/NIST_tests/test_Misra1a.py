...
class TestMisra1a(TestNonlinearLS):
    ...
    def setup(self):
        ...
        self.res_start2 = mod2.fit(start_value=[250.0, 0.00050000000000000001])

    def test_basic(self):
        res1 = self.res_start1
        res2 = self.res_start2
        assert_almost_equal(res1.params,[238.94212917999999, 0.00055015643180999997],decimal=3)
        assert_almost_equal(res2.params,[238.94212917999999, 0.00055015643180999997],decimal=3)
