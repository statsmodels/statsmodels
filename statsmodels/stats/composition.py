...
def closure(mat):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import closure
...
def multiplicative_replacement(mat, delta=None):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import multiplicative_replacement
...
def perturb(x, y):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import perturb
    >>> x = np.array([.1,.3,.4, .2])
...
def perturb_inv(x, y):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import perturb_inv
    >>> x = np.array([.1,.3,.4, .2])
    >>> y = np.array([1./6,1./6,1./3,1./3])
    >>> perturb_inv(x,y)
...
def power(x, a):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import power
    >>> x = np.array([.1,.3,.4, .2])
    >>> power(x, .1)
...
def inner(x, y):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import inner
    >>> x = np.array([.1, .3, .4, .2])
    >>> y = np.array([.2, .4, .2, .2])
...
def clr(mat):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import clr
    >>> x = np.array([.1, .3, .4, .2])
    >>> clr(x)
...
def clr_inv(mat):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import clr_inv
    >>> x = np.array([.1, .3, .4, .2])
    >>> clr_inv(x)
...
def ilr(mat, basis=None, check=True):
    ...
    -------
    np.array:
        Matrix of ilr coordinates where samples
        are rows and columns are coordinates.
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import ilr
    >>> x = np.array([.1, .3, .4, .2])
    >>> ilr(x)
...
def ilr_inv(mat, basis=None, check=True):
    ...
    -------
    np.array:
        Matrix of proportions where samples are rows and columns
        are components.
...
def centralize(mat):
    ...
    --------
    >>> import numpy as np
    >>> from statsmodels.stats.composition import centralize
