...
def notyet_atst():  # FIXME: make this a test or move/remove
    ...
    params = np.array([-272.3986041341653, 0.1779455206941112,
                       0.2149432424658157])
    cov_hac_4 = np.array([
        1321.569466333051, -0.2318836566017612,
    ...
    cov_hac_10 = np.array([
        2027.356101193361, -0.3507514463299015,
...
class TestDiagnosticG(object):
    ...
    def test_hac(self):
        ...
        cov_hac_4 = np.array([
            1.385551290884014, -0.3133096102522685,
        ...
        cov_hac_10 = np.array([
            1.257386180080192, -0.2871560199899846,
    ...
    def test_recursive_residuals(self):
        ...
        reccumres_standardize = np.array([
            -2.151, -3.748, -3.114, -3.096,
            -1.865, -2.230, -1.194, -3.500,
            -3.638, -4.447, -4.602, -4.631, -3.999,
            -4.830, -5.429, -5.435, -6.554,
            -8.093, -8.567, -7.532, -7.079, -8.468,
            ...
            -7.153, -6.447, -5.183, -3.794, -3.511,
            -3.979, -3.236, -3.793, -3.699,
            -5.056, -5.724, -4.888, -4.309, -3.688,
            -3.918, -3.735, -3.452, -2.086,
            -6.520, -7.959, -6.760, -6.855, -6.032,
            -4.405, -4.123, -4.075, -3.235,
            -3.115, -3.131, -2.986, -1.813, -4.824,
            -4.424, -4.796, -4.000, -3.390,
            -4.485, -4.669, -4.560, -3.834, -5.507,
            ...
            -2.316, -1.986, -0.744, -1.396, -1.728,
            -0.646, -2.602, -2.741, -2.289,
            -2.897, -1.934, -2.532, -3.175, -2.806,
            -3.099, -2.658, -2.487, -2.515,
            -2.224, -2.416, -1.141, 0.650, -0.947,
            ...
            11.586, 11.033, 11.335, 11.661, 10.522,
            10.392, 10.521, 10.126, 9.428, 9.734,
            8.954, 9.949, 10.595, 8.016, 6.636, 6.975])
...
def get_duncan_data():
    ...
    endog = [
        82.,  83.,  90.,  76.,  90.,  87.,  93.,  90.,  52.,  88.,  57.,
