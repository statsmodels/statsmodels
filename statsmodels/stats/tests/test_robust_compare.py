...
class Test_Trim:
    ...
    def test_trimboth(self):
        ...
        with pytest.raises(ValueError):
            trimboth(np.arange(24).reshape(4, 6).T, 4 / 6.0)
    ...
    def test_trim_mean(self):
        ...
        assert_equal(
            trim_mean(a4, 2 / 6.0), np.array([9.0, 10.0, 11.0, 12.0, 13.0, 14.0])
        )
        # shuffled arange(24)
        a = np.array(
            [
...
class TestTrimmedR1:
    ...
    def test_inference(self):
        ...
        ttw_statistic, ttw_pvalue, tt_w_df = (
            4.090283559190728,
            0.0008537789444194812,
            16,
        )
