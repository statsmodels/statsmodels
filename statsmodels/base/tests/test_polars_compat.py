...
class TestPolarsDirectConstructor:
    ...
    def setup_class(cls):
        ...
        cls.pandas_y = rg.standard_normal(cls.n)
        cls.pandas_X = np.column_stack(
            [np.ones(cls.n), rg.standard_normal(cls.n), rg.standard_normal(cls.n)]
        )
...
class TestPolarsFormulaAPI:
    ...
    def setup_class(cls):
        ...
        cls.y = rg.standard_normal(cls.n)
        cls.x1 = rg.standard_normal(cls.n)
        cls.x2 = rg.standard_normal(cls.n)
...
class TestPolarsPredict:
    ...
    def setup_class(cls):
        ...
        cls.y_train = rg.standard_normal(cls.n_train)
        cls.x1_train = rg.standard_normal(cls.n_train)
        cls.x2_train = rg.standard_normal(cls.n_train)

        cls.x1_test = rg.standard_normal(cls.n_test)
        cls.x2_test = rg.standard_normal(cls.n_test)
...
class TestPolarsEdgeCases:
    ...
    def test_polars_with_null_values(self):
        ...
        n = 30
        y = rg.standard_normal(n)
        x1 = rg.standard_normal(n)
        x2 = rg.standard_normal(n)
