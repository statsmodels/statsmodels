...
dens_normal = nparam.KDE(tdat=[support], var_type='c', bw='normal_reference')
dens_cvls = nparam.KDE(tdat=[support], var_type='c', bw='cv_ls')
dens_cvml = nparam.KDE(tdat=[support], var_type='c', bw='cv_ml')
...
ix = np.argsort(support)
dens_normal = nparam.KDE(tdat=[support], var_type='o', bw='normal_reference')
dens_cvls = nparam.KDE(tdat=[support], var_type='o', bw='cv_ls')
dens_cvml = nparam.KDE(tdat=[support], var_type='o', bw='cv_ml')
plt.figure(6)
