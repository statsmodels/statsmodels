...
model = sm.OLS(y, X)
fitted = model.fit()
EL_Inference = fitted.emplikeinf()
print 'The confidence interval for Beta 1 through OLS'
print EL_Inference.ci_params(1)
print 'Test the hypothesis that Beta 3 = 3, it''s true value'
print EL_Inference.test_beta([3], [2])  # Remember 0 indexing so Beta3 is parameter2
# This can obviously be condensed to:
print fitted.emplikeinf().test_beta([3], [2])
