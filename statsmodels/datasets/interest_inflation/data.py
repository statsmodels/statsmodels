...
DESCRLONG   = """West German (until 1990) / German (afterwards) interest and inflation rate 1972Q2 - 1998Q4"""
...
def load():
    ...
    Notes
    -----
    The interest_inflation Dataset instance does not contain endog and exog attributes.
    """
    data = _get_data()
...
def _get_data():
    ...
    with open(filepath + '/E6.csv', 'rb') as f:
