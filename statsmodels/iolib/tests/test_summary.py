...
def test_summary_params():
    ...
    desire = np.array([[ 0.46385168,  0.16195635,  2.86405365,  0.00784052,  0.13209913,
             0.79560423],
           [ 0.01049512,  0.01948285,  0.53868506,  0.59436148, -0.02941369,
             0.05040394],
           [ 0.37855479,  0.13917274,  2.72003545,  0.01108768,  0.09347235,
             0.66363722],
...
#const  -1.4980   0.5239   -2.8594  0.0079  -2.5712  -0.4249
#-----------------------------------------------------------
 #0.4639       0.1620    2.8641   0.0078    0.1321    0.7956
 #0.0105       0.0195    0.5387   0.5944   -0.0294    0.0504
 #0.3786       0.1392    2.7200   0.0111    0.0935    0.6636
#-1.4980       0.5239   -2.8594   0.0079   -2.5712   -0.4249
#===========================================================
#'''
    #np.testing.assert_(output == desire)
...
def test_col_model_names():
    output = summary_col(results, model_names=['a','b','c']).as_text()
    desire = '''
=========================================
               a          b         c    
-----------------------------------------
