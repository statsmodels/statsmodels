...
def test_summary_params():
    ...
    desire = np.array([['0.4639', '0.1620', '2.8641', '0.0078', '0.1883', '0.7394'],
       ['0.0105', '0.0195', '0.5387', '0.5944', '-0.0226', '0.0436'],
       ['0.3786', '0.1392', '2.7200', '0.0111', '0.1418', '0.6153'],
       ['-1.4980', '0.5239', '-2.8594', '0.0079', '-2.3892', '-0.6068']])
    np.testing.assert_equal(output, desire)

def test_model_info():
    output = summary_model(res)
    desire = OrderedDict([('Model:', 'OLS'), ('Dependent Variable:', 'y'), ('Date:', '2013-01-31 21:18'), ('No. Observations:', '    32'), ('Df Model:', '     3'), ('Df Residuals:', '    28'), ('Scale:', '0.1506'), ('R-squared:', '0.4159'), ('Adj. R-squared:', '0.3533'), ('AIC:', '33.9565'), ('BIC:', '39.8194'), ('Log-Likelihood:', '-12.9782')])
    np.testing.assert_equal(output, desire)
