...
class CheckModelMixin:
    ...
    def test_fit_regularized_invalid_method(self):
        ...
        with pytest.raises(ValueError, match="is not supported, use either"):
...
class CheckModelResults(CheckModelMixin):
    ...
    def test_predict(self):
        assert_almost_equal(
            self.res1.model.predict(self.res1.params), self.res2.phat, DECIMAL_4
        )

    def test_predict_xb(self):
        assert_almost_equal(
            self.res1.model.predict(self.res1.params, which="linear"),
            self.res2.yhat,
            DECIMAL_4,
        )
...
class CheckBinaryResults(CheckModelResults):
    ...
    def test_resid_generalized(self):
        assert_almost_equal(
            self.res1.resid_generalized, self.res2.resid_generalized, DECIMAL_4
        )
...
class CheckMargEff:
    ...
    def test_nodummy_dydxmean(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_dydxmean_se, DECIMAL_4
        )
    ...
    def test_nodummy_dydxmedian(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_dydxmedian_se, DECIMAL_4
        )
    ...
    def test_nodummy_dydxzero(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_dydxzero, DECIMAL_4
        )
    ...
    def test_nodummy_dyexmean(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_dyexmean_se, DECIMAL_4
        )
    ...
    def test_nodummy_dyexmedian(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_dyexmedian_se, DECIMAL_4
        )
    ...
    def test_nodummy_eydxmean(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_eydxmean_se, DECIMAL_4
        )
    ...
    def test_nodummy_eydxmedian(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_eydxmedian_se, DECIMAL_4
        )
    ...
    def test_nodummy_eydxzero(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_eydxzero_se, DECIMAL_4
        )
    ...
    def test_nodummy_eyexmean(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_eyexmean_se, DECIMAL_4
        )
    ...
    def test_nodummy_eyexmedian(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_eyexmedian_se, DECIMAL_4
        )
    ...
    def test_nodummy_eyexzero(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_eyexzero_se, DECIMAL_4
        )
    ...
    def test_dummy_dydxmean(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_dummy_dydxmean_se, DECIMAL_4
        )
    ...
    def test_dummy_eydxmean(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_dummy_eydxmean_se, DECIMAL_4
        )
    ...
    def test_count_dummy_dydxoverall(self):
        ...
        assert_almost_equal(
            me.margeff, self.res2.margeff_count_dummy_dydxoverall, DECIMAL_4
        )
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_count_dummy_dydxoverall_se, DECIMAL_4
        )

    def test_count_dummy_dydxmean(self):
        me = self.res1.get_margeff(count=True, dummy=True, at="mean")
        assert_almost_equal(
            me.margeff, self.res2.margeff_count_dummy_dydxmean, DECIMAL_4
        )
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_count_dummy_dydxmean_se, DECIMAL_4
        )
...
class TestProbitPowell(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        cls.res1 = Probit(data.endog, data.exog).fit(
            method="powell", disp=0, ftol=1e-08
        )
...
class TestProbitCG(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        res1_st = Probit(data.endog, exog_st).fit(
            method="cg", disp=0, maxiter=1000, gtol=1e-08
        )
...
class TestProbitNCG(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        cls.res2 = res2
        cls.res1 = Probit(data.endog, data.exog).fit(
            method="ncg", disp=0, avextol=1e-08, warn_convergence=False
        )
...
class TestProbitBasinhopping(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        cls.res1 = fit(
            ...
            disp=0,
            niter=5,
            minimizer={"method": "L-BFGS-B", "tol": 1e-08},
            seed=0,
        )
...
class TestProbitMinimizeDefault(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        cls.res2 = res2
        fit = Probit(data.endog, data.exog).fit
        cls.res1 = fit(method="minimize", disp=0, niter=5, tol=1e-08)
...
class TestProbitMinimizeDogleg(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        fit = Probit(data.endog, data.exog).fit
        cls.res1 = fit(
            method="minimize", disp=0, niter=5, tol=1e-08, min_method="dogleg"
        )
...
class TestNegativeBinomialGeoL1Compatability(CheckL1Compatability):
    ...
    def setup_class(cls):
        ...
        rand_exog = sm.add_constant(rand_exog, prepend=True)
        exog_no_PSI = rand_exog[:, : cls.m]
        mod_unreg = sm.NegativeBinomial(
            rand_data.endog, exog_no_PSI, loglike_method="geometric"
        )
        cls.res_unreg = mod_unreg.fit(method="newton", disp=False)
        alpha = 10 * len(rand_data.endog) * np.ones(cls.kvars)
        alpha[: cls.m] = 0
        mod_reg = sm.NegativeBinomial(
            rand_data.endog, rand_exog, loglike_method="geometric"
        )
        cls.res_reg = mod_reg.fit_regularized(
            method="l1",
            alpha=alpha,
...
class CompareL11D(CompareL1):
    ...
    def test_tests(self):
        ...
        assert_almost_equal(
            self.res1.t_test(restrictmat).pvalue,
            self.res2.t_test(restrictmat).pvalue,
            DECIMAL_4,
        )
        assert_almost_equal(
            self.res1.f_test(restrictmat).pvalue,
...
class TestLogitNewton(CheckBinaryResults, CheckMargEff):
    ...
    def test_nodummy_exog1(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_atexog1_se, DECIMAL_4
        )
    ...
    def test_nodummy_exog2(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_atexog2_se, DECIMAL_4
        )
    ...
    def test_dummy_exog1(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_dummy_atexog1_se, DECIMAL_4
        )
    ...
    def test_dummy_exog2(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_dummy_atexog2_se, DECIMAL_4
        )
    ...
    def test_diagnostic(self):
        ...
        res = dia.test_chisquare_binning(
            counts, expected, sort_var=fitted, bins=indices, df=None
        )
...
class TestPoissonNewton(CheckModelResults):
    ...
    def test_margeff_overall(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_nodummy_overall_se, DECIMAL_4
        )
    ...
    def test_margeff_dummy_overall(self):
        ...
        assert_almost_equal(
            me.margeff_se, self.res2.margeff_dummy_overall_se, DECIMAL_4
        )
    ...
    @pytest.mark.xfail(
        reason="res2.cov_params is a zero-dim array of None", strict=True
    )
    def test_cov_params(self):
...
class CheckNegBinMixin:
    ...
    @pytest.mark.xfail(
        reason="pvalues do not match, in some cases wrong size",
        strict=True,
...
class TestNegativeBinomialNB2Newton(CheckNegBinMixin, CheckModelResults):
    ...
    def test_alpha(self):
        assert isinstance(self.res1.bse, np.ndarray)
    ...
    def test_fittedvalues(self):
        assert_almost_equal(
            self.res1.fittedvalues[:10], self.res2.fittedvalues[:10], DECIMAL_3
        )
...
class CheckMNLogitBaseZero(CheckModelResults):
    ...
    def test_endog_names(self):
        assert_equal(
            self.res1._get_endog_name(None, None)[1],
...
def test_l1_regularized_respects_warning_filters():
    ...
    with pytest.warns(ConvergenceWarning):
        NegativeBinomial(endog, exog).fit_regularized(
            method="l1", alpha=1e-12, trim_mode="off", qc_verbose=False, disp=False
        )
...
def test_issue_8943():
    ...
    np.testing.assert_allclose(res0.params, res1.params, rtol=1e-06)
    res0.summary()
...
def test_negative_binomial_default_alpha_param():
    ...
    with pytest.warns(FutureWarning):
        sm.families.NegativeBinomial(
            link=sm.families.links.nbinom(alpha=1.0), alpha=1.0
        )
...
class TestGeneralizedPoisson_p2:
    ...
    def test_alpha(self):
        ...
        assert_allclose(
            self.res1.lnalpha_std_err, self.res2.lnalpha_std_err, atol=1e-05
        )
...
class TestGeneralizedPoisson_p1:
    ...
    def test_llf(self):
        poisson_llf = sm.Poisson(self.data.endog, self.data.exog).loglike(
            self.res1.params[:-1]
        )
        genpoisson_llf = sm.GeneralizedPoisson(
            self.data.endog, self.data.exog, p=1
        ).loglike(list(self.res1.params[:-1]) + [0])
        assert_allclose(genpoisson_llf, poisson_llf)

    def test_score(self):
        poisson_score = sm.Poisson(self.data.endog, self.data.exog).score(
            self.res1.params[:-1]
        )
        genpoisson_score = sm.GeneralizedPoisson(
            self.data.endog, self.data.exog, p=1
        ).score(list(self.res1.params[:-1]) + [0])
        assert_allclose(genpoisson_score[:-1], poisson_score, atol=1e-09)

    def test_hessian(self):
        poisson_score = sm.Poisson(self.data.endog, self.data.exog).hessian(
            self.res1.params[:-1]
        )
        genpoisson_score = sm.GeneralizedPoisson(
            self.data.endog, self.data.exog, p=1
        ).hessian(list(self.res1.params[:-1]) + [0])
    ...
    def test_fit_regularized(self):
        ...
        assert_allclose(
            (self.res1.params[:-2] ** 2).mean(), 0.01658095554332078, rtol=1e-05
        )
        assert_allclose(
            (res_reg1.params[:-2] ** 2).mean(), 0.016580734975068664, rtol=1e-05
        )
        assert_allclose(
            (res_reg2.params[:-2] ** 2).mean(), 0.010672558641545994, rtol=1e-05
        )
        assert_allclose(
            (res_reg3.params[:-2] ** 2).mean(), 0.00035544919793048415, rtol=1e-05
        )
...
class TestGeneralizedPoisson_underdispersion:
    ...
    def setup_class(cls):
        ...
        cls.endog = sm.distributions.genpoisson_p.rvs(
            mu_true, cls.expected_params[-1], 1, size=len(mu_true), random_state=rs
        )
        model_gp = sm.GeneralizedPoisson(cls.endog, exog, p=1)
        cls.res = model_gp.fit(
            method="nm", xtol=1e-06, maxiter=5000, maxfun=5000, disp=0
        )
    ...
    def test_newton(self):
        ...
        assert_allclose(
            res.model.score(res.params), np.zeros(len(res2.params)), atol=0.01
        )
        assert_allclose(
            res.model.score(res2.params), np.zeros(len(res2.params)), atol=1e-10
        )
        assert_allclose(res.params, res2.params, atol=0.0001)

    def test_mean_var(self):
        assert_allclose(
            self.res.predict().mean(), self.endog.mean(), atol=0.1, rtol=0.1
        )
        assert_allclose(
...
class TestNegativeBinomialPNB2Newton(CheckNegBinMixin, CheckModelResults):
    ...
    def test_alpha(self):
        ...
        assert_allclose(self.res1.lnalpha, self.res2.lnalpha)
        assert_allclose(
            self.res1.lnalpha_std_err, self.res2.lnalpha_std_err, atol=1e-07
        )

    def test_conf_int(self):
        assert_allclose(
            self.res1.conf_int(), self.res2.conf_int, atol=0.001, rtol=0.001
        )

    def test_zstat(self):
        assert_allclose(
            self.res1.pvalues[:-1], self.res2.pvalues, atol=0.005, rtol=0.005
        )
    ...
    def test_predict_xb(self):
        assert_allclose(
            self.res1.predict(which="linear")[:10], self.res2.fittedvalues[:10]
        )
...
class TestNegativeBinomialPNB2BFGS(CheckNegBinMixin, CheckModelResults):
    ...
    def test_alpha(self):
        assert isinstance(self.res1.bse, np.ndarray)
        assert_allclose(self.res1.lnalpha, self.res2.lnalpha, atol=1e-05, rtol=1e-05)
        assert_allclose(
            self.res1.lnalpha_std_err, self.res2.lnalpha_std_err, atol=1e-05, rtol=1e-05
        )
...
class TestNegativeBinomialPNB1BFGS(CheckNegBinMixin, CheckModelResults):
    ...
    def setup_class(cls):
        data = load_randhie()
        exog = sm.add_constant(data.exog, prepend=False)
        cls.res1 = NegativeBinomialP(data.endog, exog, p=1).fit(
            method="bfgs", maxiter=100, disp=0
        )
        res2 = RandHIE.negativebinomial_nb1_bfgs
        cls.res2 = res2
    ...
    def test_lnalpha(self):
        ...
        assert_allclose(
            self.res1.lnalpha_std_err, self.res2.lnalpha_std_err, atol=0.001, rtol=0.001
        )
...
class TestNegativeBinomialPPredictProb:
    ...
    def test_predict_prob_p1(self):
        ...
        assert_allclose(
            probs, nbinom.pmf(np.arange(8)[:, None], size, prob).T, atol=0.01, rtol=0.01
        )
...
def test_null_options():
    ...
    lln = res.llnull
    assert_allclose(
        res.res_null.mle_settings["start_params"], np.log(endog.mean()), rtol=1e-10
    )
...
def test_optim_kwds_prelim():
    ...
    assert_allclose(res.mle_settings["start_params"][:-1], res_poi.params, rtol=0.0001)
...
def test_mnlogit_float_name():
    ...
    with pytest.warns(
        SpecificationWarning, match="endog contains values are that not int-like"
    ):
