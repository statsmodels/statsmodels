...
class RandHIE():
    ...
    def negativebinomial_nb2_bfgs(self):
        ...
        self.alpha = 1.292953339909746
        self.alpha_std_err = .0186098
        ...
        self.conf_int = [
            [-0.06984584,-0.046048071],
            [-0.31210829,-0.223467147],
            [ 0.03325745, 0.049154700],
            [-0.04488902,-0.031386344],
            [ 0.21034018, 0.327491365],
            [ 0.03537228, 0.040955214],
            [-0.08321127,-0.005056504],
    ...
    def negativebinomial_nb1_bfgs(self):
        ...
        self.params = [-0.065309744899923, -0.296016207412261,
                ...
                # from R, we report lnalpha not alpha
                #3.73086958562569]
                # from Stata
                1.316716867203]
        self.alpha = 3.73086958562569
        self.bse = [0.00536019929563678,
                ...
                # from R, we report lnalpha(alpha)
                #0.0630011409376052]
                # from Stata
                .0168876692]
        self.alpha_std_err = 0.0630011409376052
        ...
        self.conf_int = [[ -7.58299742e-02,  -5.48182192e-02],
           ...
           [ -3.79207829e-02,  -2.61166115e-02],
           [  1.43953807e-01,   2.37244495e-01],
           [  2.97655488e-02,   3.39753457e-02],
           [ -6.58433254e-02,  -4.13367625e-04],
           [ -1.06798232e-01,   1.00656859e-02],
           [  4.70711781e-03,   2.19097224e-01],
           [  7.15131231e-01,   7.99298199e-01],
