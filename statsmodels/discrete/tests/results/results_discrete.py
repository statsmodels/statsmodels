...
class RandHIE():
    ...
    def negativebinomial_nb2_bfgs(self):
        # Stata-verified 2012/11/29
        self.bse = [ 0.00608971,  0.02269305,  0.004147  ,  0.00339951,  0.02994524,
                     0.00146323,  0.0200523 ,  0.03614492,  0.07426257,  0.0247712 ,
                     0.01860976]
        self.z = [-9.51673752, -11.80158636,   9.9374587 , -11.21932322,
                  8.98154238,  26.0812921 ,  -2.20013018,   0.47700341,
                  2.39694939,  26.78757006,  13.80614921]
        self.df_model = 9.0
        self.df_resid = 20180.0
        self.params = [-0.05795413, -0.26781396,  0.04121061, -0.03814017,  0.26895441,
                        0.03816294, -0.04411766,  0.01724125,  0.17800361,  0.66356013,
                        0.25692914]
        self.cov_params = None
        self.bic = 86866.453587506097
        self.aic = 86787.324160393022
        self.prsquared = 0.018453071139475918 
        self.llnull = -44199.27443567117
        self.llf = -43383.662080196511
        self.llr = 1631.2247109493183
        self.llr_pvalue = 0.0
        self.conf_int = [[-0.06988974, -0.04601853],
           [-0.31229152, -0.2233364 ],
           [ 0.03308264,  0.04933857],
           [-0.04480308, -0.03147726],
           [ 0.21026283,  0.327646  ],
           [ 0.03529506,  0.04103082],
           [-0.08341944, -0.00481588],
           [-0.0536015 ,  0.088084  ],
           [ 0.03245166,  0.32355557],
           [ 0.61500948,  0.71211078],
           [ 0.22045468,  0.29340361]]
        self.pvalues = [1.78701196e-021,   3.83021917e-032,   2.86030968e-023,
                        3.27769167e-029,   2.66997242e-019,   5.94405033e-150,
                        2.77976599e-002,   6.33359693e-001,   1.65322071e-002,
                        4.51033593e-158,   2.34010618e-043]

    def negativebinomial_nb1_bfgs(self):
        # Method bfgs
        self.bse = [ 0.0053599 ,  0.01969976,  0.00335788,  0.00301125,  0.02380126,
                     0.00107396,  0.0167008 ,  0.02981834,  0.05467508,  0.02147126,
                     0.01688753]
        self.z = [-12.18694187, -15.02585872,  12.2668625 , -10.63680106,
                  8.00888507,  29.67849941,  -1.99298616,  -1.62995047,
                  2.04454048,  35.26877096,  77.96934167]
        self.df_model = 9.0
        self.df_resid = 20180.0
        self.params = [-0.06532085, -0.2960058 ,  0.04119071, -0.03203004,  0.19062159,
                        0.03187347, -0.03328447, -0.04860241,  0.11178542,  0.7572651 ,
                        1.3167099 ]
        self.cov_params = None
        self.bic = 86656.641706200971 
        self.aic = 86577.512279087896
        self.prsquared = 0.020826547672563533
        self.llnull = -44199.27443567117
        self.llf = -43278.756139543948 
        self.llr = 1841.0365922544443
        self.llr_pvalue = 0.0
        self.conf_int = [[ -7.58260686e-02,  -5.48156278e-02],
                   [ -3.34616623e-01,  -2.57394985e-01],
                   [  3.46093790e-02,   4.77720460e-02],
                   [ -3.79319735e-02,  -2.61281014e-02],
                   [  1.43971966e-01,   2.37271205e-01],
                   [  2.97685472e-02,   3.39783858e-02],
                   [ -6.60174355e-02,  -5.51496732e-04],
                   [ -1.07045279e-01,   9.84045437e-03],
                   [  4.62422670e-03,   2.18946615e-01],
                   [  7.15182199e-01,   7.99348009e-01],
                   [  1.28361094e+00,   1.34980886e+00]] 
        self.pvalues = [3.64857758e-034,   4.97129055e-051,   1.36438512e-034,
                        2.00908959e-026,   1.15753014e-015,   1.45486485e-193,
                        4.62629630e-002,   1.03111967e-001,   4.09001831e-002,
                        1.76906511e-272,   0.00000000e+000]

    def negativebinomial_geometric_bfgs(self):
        self.bse = [ 0.00553848,  0.02061897,  0.00375873,  0.00309236,  0.02701419,
                     0.0013217 ,  0.01821654,  0.03256024,  0.06665311,  0.02249932]
        self.z = [-10.42572377, -12.9286821 ,  10.88280208, -12.27155157,
                  9.95419774,  28.75444256,  -2.33728547,   0.63033975,
                  2.70594754,  29.54085131]
        self.df_model = 9.0
        self.df_resid = 20180.0
        self.params = [-0.05774269, -0.2665761 ,  0.0409055 , -0.03794807,  0.26890459,
                        0.03800476, -0.04257725,  0.02052401,  0.18035982,  0.66464895]
        self.cov_params = None
        self.bic = 87180.290032620993 
        self.aic = 87101.160605507917
        self.prsquared = 0.014902826829790938
        self.llnull = -44199.27443567117
        self.llf = -43540.580302753959
        self.llr = 1317.3882658344228 
        self.llr_pvalue = 5.4304035871254514e-278 
        self.conf_int = [[-0.06859791, -0.04688746],
                   [-0.30698854, -0.22616366],
                   [ 0.03353852,  0.04827247],
                   [-0.04400898, -0.03188715],
                   [ 0.21595775,  0.32185143],
                   [ 0.03541427,  0.04059524],
                   [-0.078281  , -0.00687349],
                   [-0.04329289,  0.08434092],
                   [ 0.04972212,  0.31099751],
                   [ 0.6205511 ,  0.7087468 ]]
        self.pvalues = [1.89213218e-025,   3.10088601e-038,   1.39216438e-027,
                        1.28761984e-034,   2.41764917e-023,   7.97023551e-182,
                        1.94243455e-002,   5.28472323e-001,   6.81098041e-003,
                        8.60791182e-192]
