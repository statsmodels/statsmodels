...
class RandHIE(object):
    ...
    def generalizedpoisson_gp2(self):
        ...
        self.params = [0.651125316, -0.0604495342, -0.277717228, 0.0438136144,
                      -0.0395811744,  0.273044906, 0.0399108677, -0.0552626543,
                      -0.001227569488, 0.151980519, 0.448085318
                ]
        self.lnalpha_std_err  = 0.0125607
        self.lnalpha = -0.8027716
        self.bse = [0.02626823, 0.00634704, 0.02381906, 0.00443871, 0.00355094,
                    0.0334247, 0.00166303, 0.02102142, 0.0390845, 0.087821,
                    0.00562825
                ]
        self.df_model = 9
        ...
        self.llr_pvalue = 4.8795019354e-254
