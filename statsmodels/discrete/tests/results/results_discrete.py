...
class RandHIE(object):
    ...
    def generalizedpoisson_gp2(self):
        ...
        self.params = [0.6511253, -0.0604495, -0.2777172, 0.0438136,
                      -0.0395812,  0.2730449, 0.0399109, -0.0552627,
                      -0.0012277, 0.1519805, 0.4480853
                ]
        self.lnalpha_std_err  = 0.0125607
        self.lnalpha = -0.8027716
        self.bse = [0.0262682, 0.006347, 0.0238191, 0.0044387, 0.0035509,
                    0.0334247, 0.001663, 0.0210214, 0.0390845, 0.087821,
                    0.0056
                ]
        self.aic = 86674.854
        self.conf_int = [
