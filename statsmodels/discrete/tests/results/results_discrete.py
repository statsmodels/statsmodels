...
class Anes:
    ...
    def mnlogit_basezero():
        ...
        obj.resid = np.loadtxt(
            Path(cur_dir).joinpath("mnlogit_resid.csv"), delimiter=","
        )
        return obj
...
class RandHIE:
    ...
    def poisson():
        ...
        predict = np.loadtxt(Path(cur_dir).joinpath("yhat_poisson.csv"), delimiter=",")
        obj.phat = predict[:, 0]
        obj.yhat = predict[:, 1]
        ...
        obj.resid = np.loadtxt(
            Path(cur_dir).joinpath("poisson_resid.csv"), delimiter=","
        )
        return obj
