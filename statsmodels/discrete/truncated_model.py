...
class _RCensoredGeneric(CountModel):
    ...
    def __init__(
        self, endog, exog, offset=None, exposure=None, missing="none", **kwargs
    ):
...
class _RCensoredGeneralizedPoisson(_RCensoredGeneric):
    ...
    def __init__(
        self, endog, exog, offset=None, p=2, exposure=None, missing="none", **kwargs
    ):
        super().__init__(
            endog, exog, offset=offset, exposure=exposure, missing=missing, **kwargs
        )
...
class HurdleCountModel(CountModel):
    ...
    def fit(
        ...
        **kwargs,
        ...
        result._results.params = np.append(
            results1._results.params, results2._results.params
        )
