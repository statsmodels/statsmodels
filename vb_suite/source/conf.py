# -*- coding: utf-8 -*-
#
# Adapted from pandas on 2013-09-09
#
...
copyright = u'2008-2013, the statsmodels development team'
...
version = '%s' % (statsmodels.__version__)
...
html_title = 'Vbench performance benchmarks for statsmodels'
