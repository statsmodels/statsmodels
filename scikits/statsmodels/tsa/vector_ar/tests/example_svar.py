...
#res.irf(periods=30).plot(impulse='realgdp', plot_stderr=True, stderr_type='mc')
myVAR = VAR(data, names=names).fit(maxlags=3)
myVAR.irf(periods=30).plot(impulse='realgdp',plot_stderr=True, stderr_type='mc')
